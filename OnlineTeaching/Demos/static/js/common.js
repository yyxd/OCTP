;(function (win, doc, $, undefined) {
    ...
    discussion.addUserTodiscussion = function(ev) {
        ...
        if (obj.hasClass('discussion_selected')) {
            ...
            var userToDiscussionStr = '<li targetType="4" targetId="{0}" targetName="{1}"><span class="user_img"><img src="../Demos/static/img/communicate/personPhoto.png"/></span> <span class="user_name">{1}</span><a href="javascript:void(0)" class="discussion_delete_user"></a></li>';
    ...
    popBox.init = function() {
        ...
        for (i in friendList) {
            ...
            var friendListStr = '<li targetType="4" targetId="{0}" targetName="{1}"><span class="user_img"><img src="../Demos/static/img/communicate/personPhoto.png"/></span> <span class="user_name">{1}</span><a href="javascript:void(0)" class="discussion_select_user"></a></li>';
